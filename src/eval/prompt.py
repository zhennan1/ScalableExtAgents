gpt4_templates = {
    ...
    # "longbook_qa_eng": "Read the following article and extract as much information as possible related to the problem.\n\n{context}\n\nQuestion: {question}\n\n",  # noqa
    "longbook_qa_eng": "Read the following article and extract as much original text as possible that is relevant to the question. Do not add any of your own explanations, inferences, or additional information.\n\n{context}\n\nQuestion: {question}\n\n",  # noqa   
    # "longbook_qa_eng": "Read the book below and answer a question. Provide the answer as short as possible, word or phrase.\n\n{context}\n\nQuestion: {question}\n\n",  # noqa
    ...
    "longbook_choice_eng": "Read the following passage and extract relevant information related to the question.\n\n{context}\n\nQuestion: {question}\n\nOptions:\nA. {OPTION_A}\nB. {OPTION_B}\nC. {OPTION_C}\nD. {OPTION_D}\n\nProvide the extracted information in a concise format as: 'Extracted Information: {{info}}', 'Rationale: {{rationale}}', 'Answer: {{answer}}', 'Confidence Score: {{score}}'. If no information, just output NO INFORMATION",  # noqa
    # "longbook_sum_eng": "Summarize the following book.\n\n{context}",  # noqa
    "longbook_sum_eng": "Summarize the following section of the book.\n\n{context}",  # noqa
    # "longbook_qa_chn": "请根据以下书籍回答我的问题。\n\n{context}\n\n问题：{question}\n请尽量简短地回答。",  # noqa
    "longbook_qa_chn": "请阅读以下文章并尽可能提取与问题相关的信息。\n\n{context}\n\n问题：{question}\n\n",  # noqa
    # "longbook_qa_chn": "请阅读以下文章并回答问题。请尽量简短地回答，只使用一个或多个词语。\n\n{context}\n\n问题：{question}\n\n",  # noqa
    "math_find": "{prefix}\n\n{context}\n\n{input}",
